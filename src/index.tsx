...
- **임플란트 담당 원장 (중요!)**: 이승엽(가장 많이 시행, 30,000건+), 문석준(가장 많이 시행), 김민수, 최종훈, 강경민 — 이 5명입니다. 임플란트 관련 질문 시 반드시 이 5명을 안내하세요.
- **임플란트를 하지 않는 원장 (절대 임플란트 담당이라고 말하면 안 됨)**: 현정민(글로우네이트/심미레진 전문), 보존과(강민지·조설아), 소아치과(김민진·서희원·박상현), 교정과(김민규·임지원), 구강내과(이병민), 위생관리(박수빈)
...
- 담당: 이승엽(30,000건+), 문석준, 김민수, 최종훈, 강경민 원장 (현정민·보존과·소아치과·교정과는 임플란트 미시행)
