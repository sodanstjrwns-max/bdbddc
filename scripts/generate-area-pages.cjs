...
const regions = [
  // ── 충청남도 ──
  {
    id: 'cheonan', name: '천안', fullName: '천안시', province: '충청남도', provinceShort: '충남',
    slug: 'cheonan.html', distance: '5km', carTime: '10분', transitTime: '20분',
    carRoute: '천안IC에서 약 15분 소요',
    transit: '시내버스 11, 12, 21, 22번 불당동 정류장 하차 도보 3분',
  ...
  },
  {
    ...
    slug: 'buldang.html', distance: '1km', carTime: '5분', transitTime: '10분',
    carRoute: '불당동 내 도보 5~10분 거리',
    transit: '불당동 정류장에서 도보 3분',
  ...
  },
  {
    ...
    slug: 'asan.html', distance: '20km', carTime: '20분', transitTime: '40분',
    carRoute: '아산시청 방면 → 천안-아산 고속도로 이용 약 20분',
  ...
  },
  {
    ...
    slug: 'dangjin.html', distance: '60km', carTime: '50분', transitTime: '80분',
    carRoute: '당진IC → 서해안고속도로 → 천안-논산고속도로 약 50분',
  ...
  },
  {
    ...
    slug: 'seosan.html', distance: '70km', carTime: '60분', transitTime: '90분',
    carRoute: '서산IC → 서해안고속도로 → 천안 방면 약 60분',
  ...
  },
  {
    ...
    slug: 'hongseong.html', distance: '55km', carTime: '50분', transitTime: '80분',
    carRoute: '홍성IC → 서해안고속도로 → 천안 방면 약 50분',
    transit: '홍성버스터미널 → 천안행 시외버스(약 70분) → 택시 10분',
    ktx: '홍성역(KTX) → 천안아산역(KTX) 환승 약 20분 + 택시 10분',
  ...
  },
  {
    ...
    slug: 'yesan.html', distance: '40km', carTime: '40분', transitTime: '60분',
    carRoute: '예산 → 21번 국도 → 천안 방면 약 40분',
  ...
  },
  {
    ...
    slug: 'gongju.html', distance: '45km', carTime: '40분', transitTime: '70분',
    carRoute: '공주IC → 천안-논산고속도로 → 천안 방면 약 40분',
  ...
  },
  {
    ...
    slug: 'nonsan.html', distance: '50km', carTime: '45분', transitTime: '70분',
    carRoute: '논산IC → 천안-논산고속도로 약 45분',
  ...
  },
  {
    ...
    slug: 'cheongyang.html', distance: '55km', carTime: '50분', transitTime: '80분',
    carRoute: '청양 → 36번 국도 → 공주 → 천안-논산고속도로 약 50분',
  ...
  },
  {
    ...
    slug: 'buyeo.html', distance: '60km', carTime: '55분', transitTime: '80분',
    carRoute: '부여 → 천안-논산고속도로 경유 약 55분',
    transit: '부여버스터미널 → 천안행 시외버스(약 70분) → 택시 10분',
  ...
  },
  {
    ...
    slug: 'seocheon.html', distance: '70km', carTime: '60분', transitTime: '90분',
    carRoute: '서천IC → 서해안고속도로 → 천안 방면 약 60분',
  ...
  },
  {
    ...
    slug: 'boryeong.html', distance: '65km', carTime: '60분', transitTime: '90분',
    carRoute: '보령IC → 서해안고속도로 → 천안 방면 약 60분',
    transit: '보령버스터미널 → 천안행 시외버스(약 80분) → 택시 10분',
    ktx: '천안아산역(KTX) 환승 시 택시 10분',
  ...
  },
  {
    ...
    slug: 'taean.html', distance: '80km', carTime: '70분', transitTime: '100분',
    carRoute: '태안 → 서해안고속도로 경유 → 천안 방면 약 70분',
  ...
  },
  {
    ...
    slug: 'geumsan.html', distance: '55km', carTime: '50분', transitTime: '80분',
    carRoute: '금산 → 천안-논산고속도로 → 천안 방면 약 50분',
    transit: '금산버스터미널 → 천안행 시외버스(약 70분) → 택시 10분',
  ...
  },
  {
    ...
    slug: 'gyeryong.html', distance: '40km', carTime: '35분', transitTime: '60분',
    carRoute: '계룡시 → 천안-논산고속도로 → 천안 방면 약 35분',
  ...
  // ── 세종·대전 ──
  {
    id: 'sejong', name: '세종', fullName: '세종특별자치시', province: '세종특별자치시', provinceShort: '세종',
    slug: 'sejong.html', distance: '40km', carTime: '35분', transitTime: '60분',
    carRoute: '세종시 → 천안-세종고속도로 약 35분',
    transit: '세종시 BRT → 천안행 시외버스(약 50분) → 택시 10분',
  ...
  },
  {
    ...
    slug: 'yeongi.html', distance: '35km', carTime: '30분', transitTime: '50분',
    carRoute: '연기면 → 1번 국도 → 천안 방면 약 30분',
    transit: '연기면 → 천안행 버스(약 40분) → 택시 10분',
    ktx: '오송역(KTX) → 천안아산역(KTX) + 택시 10분',
  ...
  },
  {
    ...
    slug: 'daejeon.html', distance: '50km', carTime: '40분', transitTime: '60분',
    carRoute: '대전IC → 경부고속도로 → 천안IC 약 40분',
  ...
  // ── 충청북도 ──
  {
    id: 'cheongju', name: '청주', fullName: '청주시', province: '충청북도', provinceShort: '충북',
    slug: 'cheongju.html', distance: '55km', carTime: '50분', transitTime: '70분',
    carRoute: '청주IC → 중부고속도로 → 천안 방면 약 50분',
    transit: '청주시외버스터미널 → 천안행 버스(약 60분) → 택시 10분',
    ktx: '오송역(KTX) → 천안아산역(KTX) 약 10분 + 택시 10분',
  ...
  },
  {
    ...
    slug: 'jincheon.html', distance: '40km', carTime: '40분', transitTime: '60분',
    carRoute: '진천 → 중부고속도로 → 천안 방면 약 40분',
  ...
  },
  {
    ...
    slug: 'chungju.html', distance: '70km', carTime: '60분', transitTime: '90분',
    carRoute: '충주IC → 중부고속도로 → 천안 방면 약 60분',
  ...
  },
  {
    ...
    slug: 'eumseong.html', distance: '50km', carTime: '50분', transitTime: '70분',
    carRoute: '음성IC → 중부고속도로 → 천안 방면 약 50분',
  ...
  },
  {
    ...
    slug: 'okcheon.html', distance: '60km', carTime: '55분', transitTime: '80분',
    carRoute: '옥천IC → 경부고속도로 → 천안IC 약 55분',
  ...
  },
  {
    ...
    slug: 'yeongdong.html', distance: '75km', carTime: '60분', transitTime: '90분',
    carRoute: '영동IC → 경부고속도로 → 천안IC 약 60분',
    transit: '영동역 → 천안역(무궁화 약 70분) → 택시 10분',
    ktx: '대전역(KTX) 환승 → 천안아산역(KTX) + 택시 10분',
  ...
  // ── 경기도 ──
  {
    id: 'pyeongtaek', name: '평택', fullName: '평택시', province: '경기도', provinceShort: '경기',
    slug: 'pyeongtaek.html', distance: '50km', carTime: '45분', transitTime: '60분',
    carRoute: '평택IC → 경부고속도로 → 천안IC 약 45분',
  ...
  },
  {
    ...
    slug: 'anseong.html', distance: '45km', carTime: '40분', transitTime: '60분',
    carRoute: '안성IC → 경부고속도로 → 천안IC 약 40분',
  ...
  },
  {
    ...
    slug: 'osan.html', distance: '65km', carTime: '60분', transitTime: '80분',
    carRoute: '오산IC → 경부고속도로 → 천안IC 약 60분',
...
function generateHTML(r) {
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "itemListElement":[
      ...
      {"@type":"ListItem","position":3,"name":`${r.name}에서 오시는 길`,"item":`https://bdbddc.com/area/${r.slug}`}
    ]
  });

  // Schema: FAQPage (5 questions)
  const faqSchema = JSON.stringify({
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": `${r.name}에서 서울비디치과까지 얼마나 걸리나요?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `${r.fullName}에서 서울비디치과(천안시 서북구 불당동)까지 약 ${r.distance}이며, 차량 약 ${r.carTime}으로 오실 수 있습니다. ${r.ktx}`
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": `${r.name}에서 출발하면 주차가 가능한가요?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `네, 서울비디치과는 건물 내 무료 주차장을 운영하고 있습니다(약 30대). ${r.name}에서 자가용으로 오시는 분들도 편하게 주차하실 수 있습니다. 네비게이션에 "천안스퀘어 또는 서울비디치과"을 검색하세요.`
        }
      },
      {
        "@type": "Question",
        "name": `${r.name}에서 야간이나 주말에도 진료 가능한가요?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `서울비디치과는 365일 진료합니다. 평일 09:00~20:00(야간진료), 토·일요일 09:00~17:00, 공휴일 09:00~13:00 운영하여 ${r.name}에서 주말이나 야간에도 편하게 방문하실 수 있습니다.`
        }
      },
      {
        "@type": "Question",
        "name": `${r.name}에서 왜 서울비디치과까지 가야 하나요?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": r.whyFar
        }
  ...
  // Schema: Dentist + MedicalBusiness
  ...
  // Schema: SpeakableSpecification (별도)
  const speakableSchema = JSON.stringify({
    ...
    "url": `https://bdbddc.com/area/${r.slug}`
  }, null, 2);
...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://bdbddc.com/area/${r.slug}">
  ...
  <meta property="og:url" content="https://bdbddc.com/area/${r.slug}">
    ...
    <div class="container hero-content">
      <div class="hero-text">
        ...
        <div class="hero-trust-row reveal delay-3">
          ...
          <span class="hero-trust-divider"></span>
          <span class="hero-trust-item"><i class="fas fa-car"></i> ${r.name}에서 차로 ${r.carTime}</span>
  ...
  <section class="why-section section" aria-label="${r.name}에서 오시는 길">
    <div class="container">
      <div class="section-header reveal">
        ...
        <p class="section-subtitle">${r.fullName}에서 차로 ${r.carTime} (약 ${r.distance}) — 충남 천안시 서북구 불당34길 14</p>
      </div>
      ...
      <div class="why-grid" style="grid-template-columns: repeat(2, 1fr);">
        <div class="why-card reveal delay-1">
          ...
          <div class="why-card-stat"><span class="num">${r.carTime}</span><span class="unit">차량 소요시간</span></div>
        </div>
  ...
  <section class="why-section section" style="padding-top:0;" aria-label="왜 서울비디치과인가">
    <div class="container">
      <div class="section-header reveal">
        ...
        <p class="section-subtitle">${r.fullName}에서 차로 ${r.carTime}, 서울대병원급 진료를 받으실 수 있습니다</p>
      </div>
  ...
  <section class="treatment-section section" aria-label="${r.name} 환자 주요 진료">
    <div class="container">
      <div class="section-header reveal">
        ...
        <p class="section-subtitle treatment-intro">${r.name} 환자분들은 주로 임플란트, 인비절라인 교정, 글로우네이트(라미네이트) 진료를 많이 받으십니다. ${r.implantNote}</p>
      </div>
      ...
      <div class="treatment-grid">
        ...
        <a href="../treatments/aesthetic.html" class="treatment-card reveal delay-2">
          ...
          <h3>심미치료</h3>
          <p>라미네이트 · 미백<br>삭제량 0.3mm 이하 설계 · 5F</p>
        </a>
      </div>
  ...
  <section class="why-section section" aria-label="${r.name} 자주 묻는 질문">
    <div class="container">
      ...
      <div class="faq-list" style="max-width:800px;margin:0 auto;">
        <div class="why-hero-card reveal delay-1" style="margin-bottom:16px;text-align:left;">
          <h3 style="font-size:1.05rem;margin-bottom:8px;"><i class="fas fa-q" style="color:var(--brand-gold);margin-right:8px;"></i>${r.name}에서 서울비디치과까지 얼마나 걸리나요?</h3>
          <p class="faq-answer" style="font-size:0.95rem;line-height:1.7;">${r.fullName}에서 서울비디치과(천안시 서북구 불당동)까지 약 ${r.distance}이며, 차량 약 ${r.carTime}으로 오실 수 있습니다. ${r.ktx}</p>
        </div>
        ...
        <div class="why-hero-card reveal delay-3" style="margin-bottom:16px;text-align:left;">
          ...
          <p class="faq-answer" style="font-size:0.95rem;line-height:1.7;">네, 서울비디치과는 건물 내 무료 주차장을 운영하고 있습니다(약 30대). ${r.name}에서 자가용으로 오시는 분들도 편하게 주차하실 수 있습니다. 네비게이션에 "천안스퀘어 또는 서울비디치과"을 검색하세요.</p>
        </div>
        <div class="why-hero-card reveal delay-1" style="margin-bottom:16px;text-align:left;">
          <h3 style="font-size:1.05rem;margin-bottom:8px;"><i class="fas fa-q" style="color:var(--brand-gold);margin-right:8px;"></i>${r.name}에서 야간이나 주말에도 진료 가능한가요?</h3>
          <p class="faq-answer" style="font-size:0.95rem;line-height:1.7;">서울비디치과는 365일 진료합니다. 평일 09:00~20:00(야간진료), 토·일요일 09:00~17:00, 공휴일 09:00~13:00 운영하여 ${r.name}에서 주말이나 야간에도 편하게 방문하실 수 있습니다.</p>
        </div>
        <div class="why-hero-card reveal delay-2" style="margin-bottom:16px;text-align:left;">
          <h3 style="font-size:1.05rem;margin-bottom:8px;"><i class="fas fa-q" style="color:var(--brand-gold);margin-right:8px;"></i>${r.name}에서 왜 서울비디치과까지 가야 하나요?</h3>
          <p class="faq-answer" style="font-size:0.95rem;line-height:1.7;">${r.whyFar}</p>
        </div>
      </div>
    </div>
  </section>
...
regions.forEach(r => {
  const filePath = path.join(areaDir, r.slug);
  const existed = fs.existsSync(filePath);
  fs.writeFileSync(filePath, generateHTML(r), 'utf8');
  if (existed) {
    updated++;
    console.log(`[UPDATED] area/${r.slug} — ${r.name} (${r.fullName})`);
  } else {
    created++;
    console.log(`[CREATED] area/${r.slug} — ${r.name} (${r.fullName})`);
  }
});
...
// Schema 요약
console.log('\n📊 Schema.org 구조:');
console.log('  ✓ BreadcrumbList (3단계: 홈 → 오시는 길 → 지역)');
console.log('  ✓ FAQPage (5개 FAQ + SpeakableSpecification)');
console.log('  ✓ Dentist + MedicalBusiness (복합 타입)');
